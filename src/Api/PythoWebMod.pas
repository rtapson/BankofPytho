...
type
  TPythoWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TPythoWebModule;
...
procedure TPythoWebModule.WebModuleCreate(Sender: TObject);
begin
  ...
  // Controllers
  FMVC.AddController(TAccountsController);
  // Controllers - END
...
procedure TPythoWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
