...
uses
  ...
  MVCFramework.Signal,
  AuthorizationController in 'Authorization\AuthorizationController.pas',
  PythoWebMod in 'PythoWebMod.pas' {PythoWebModule: TWebModule},
  AuthorizationDto in 'Authorization\AuthorizationDto.pas',
  AccountController in 'Accounts\AccountController.pas',
  Accounts in 'Model\Accounts.pas',
  AccountTypes in 'Model\AccountTypes.pas',
  PythoContext in 'Model\PythoContext.pas',
  ConnectionModule in 'ConnectionModule.pas' {PythoConnection: TDataModule},
  AccountService in 'Accounts\AccountService.pas',
  ServiceRegistration in 'ServiceRegistration.pas';
...
begin
  ...
  TMVCSqids.SQIDS_ALPHABET := dotEnv.Env('dmvc.sqids.alphabet', 'qHM7uSkbmx9CGnc4BfDeyz0djoa1Yl6sRNIKwOpUhgA58EFPvQVJ3LXriTtWZ2');
